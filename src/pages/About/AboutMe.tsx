...
const AboutMe = () => {
  return (
    <PositionedMainContent title='About me'>
      ...
      <PostContent>
        <Paragraph>
          I spend more time on this page than on all the others combined. I've always struggled with
          writing, and this project is part of my effort to become a better writer.
        </Paragraph>

        <Paragraph>
          First of all, I'm just a guy who wants to create something with his own hands. For a while
          now, I've felt that I don't want to just consume content—videos, books, video games, and
          so on. I've felt the urge to create something myself. Since I'm a programmer, I decided to
          build my own website and put my ideas about beauty into it.
        </Paragraph>
